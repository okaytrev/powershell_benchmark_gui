...
#Textbox for 1 hour timer
$textbox1 = New-Object System.Windows.Forms.TextBox
$textbox1.Location = New-Object System.Drawing.Size(540,30)
#$textbox1.Size = New-Object System.Drawing.Size(200,100)
$main_form.Controls.Add($texbox1)




#Textbox for 30 minute timer
$textbox2 = New-Object System.Windows.Forms.TextBox
$textbox2.Location = New-Object System.Drawing.Size(180,30)
#$textbox2.Size = New-Object System.Drawing.Size(200,100)
$main_form.Controls.Add($texbox2) 


#1 hour button
$Button11 = New-Object System.Windows.Forms.Button
$Button11.Location = New-Object System.Drawing.Size(365,20)
$Button11.Size = New-Object System.Drawing.Size(150,40)
$Button11.Text = "1 hour timer"
$Button11.Font = "Arial"
...
$Button12.Location = New-Object System.Drawing.Size(10,20)
$Button12.Size = New-Object System.Drawing.Size(150,40)
$Button12.Text = "30 minute timer"
$Button12.Font = "Arial"
...
$Button11.Add_Click(
{
$script:countdown = [timespan]'01:00:00' # 10 minutes
$textbox1.Text = "$countown"
$timer1.Start()  
$timer1.stop() 
...
Start-process -wait $passmark $argspm
...
[System.Windows.MessageBox]::Show('Performance test ran three times, Results are located in C:\Certification\Data\Performancetest.csv, they are also populated in GUI')
...
#Populate performance Data label if the data exist

#--------------------------------------------------------
if (Test-Path -path C:\Certification\data\PerformanceTest.csv)
{
$PerformanceData = import-csv C:\Certification\data\PerformanceTest.csv |  select -Skip 6 -ExpandProperty "PassMark Rating (Composite average)" 
$Label8.Text = "$performancedata"
